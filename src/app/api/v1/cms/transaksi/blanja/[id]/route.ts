...
import * as useServices from "../belanjaRepository";
...
const getBlanjaByKodeMitraCached = (id: string) =>
	unstable_cache(
		async () => {
			...
			return await useServices.GetKodeMitra(id);
		},
		["mitra-blanja-cache", id], // cache key unik per id
		{ revalidate: 1000, tags: ["mitra-blanja-cache"] }
	)();
